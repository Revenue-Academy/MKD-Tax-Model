...
ETR_charts_fun <- function(nace_large_companies,nace_companies_small, forecast_horizon) {
...
# IV. Chart ETR small -------------------------------------------
  ...
  dist_centile_groups_small_plot <- plot_ly(percentile_small_companies_percentile, x = ~percentile_group, y = ~ETR_bu, name = "Baseline", type = 'scatter', mode = 'lines',
                                            line = list(width = 4,dash = "solid"))
